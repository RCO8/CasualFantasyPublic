...
public class PhysicalEnemy_Field : NPC
{
    public Animator animator;
    public RectTransform rectTransform;
    public NormalEnemyAnimation physicalAnimation;
    ...
    protected override void Awake()
    {
        ...
        physicalAnimation = new NormalEnemyAnimation();
        physicalAnimation.Initialize();
    }
